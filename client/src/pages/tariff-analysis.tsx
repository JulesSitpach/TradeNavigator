      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <Button 
              onClick={() => setShowExistingAnalysis(!showExistingAnalysis)}
              variant={showExistingAnalysis ? "default" : "outline"}
            >
              {showExistingAnalysis ? "New Analysis" : "Show Example"}
            </Button>
        ...
        {/* Either show the new form or the existing analysis */}
        {showExistingAnalysis ? (
          ...
          // New form with our enhanced validation and caching
          <>
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                ...
                <CardDescription>Calculate duties, taxes, and find savings opportunities</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-start">
                  <Info className="text-blue-500 mt-0.5 mr-3 flex-shrink-0" size={18} />
                  <div>
                    <h4 className="text-blue-800 font-medium mb-1">Enhanced Features</h4>
                    <p className="text-sm text-blue-700">
                      This form features real-time validation, intelligent caching to prevent data loss, 
                      and country-specific requirement lookup. Form data is automatically saved as you type.
                    </p>
                  </div>
                </div>
